...
#
#
#load('Peter0811_DDbin9tau.Rdata')
#Fname.out = c('Results_Bintauweights_plots_Peter0811.Rdata')
#load('Paul1315_DDbin9tau.Rdata')
#Fname.out = c('Results_Bintauweights_plots_Paul1315.Rdata')
#piglab ='Phycocyanin'
load('DDbin9tau_Peter1315.Rdata')
Fname.out = c('Results_Bintauweights_plots_Peter1315.Rdata')
...
x = seq(-5.5,xeq[2],length.out=30)  # wide range
...
# Right basin 
  ...
  x = seq(xeq[2],5.5,length.out=30)  # wide interval
  # solve with bvpcol or bvptwp
  trycol <- bvptwp(yini = yini, x = x, func = feval2, yend = yend, parm=plist)
